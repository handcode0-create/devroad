...
class DevRoadStacksSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($courses as $technology => $course) {
            ...
            if ($roadmap->title !== $course['title'] || ! $roadmap->description) {
                $roadmap->update([
                    'title' => $course['title'],
                    'description' => $course['description'],
            ...
            foreach ($course['lessons'] as $index => $lesson) {
                $roadmap->steps()->updateOrCreate(
                    ...
                    [
                        ...
                        'code_example' => $course['code'][$index],
                        'estimated_minutes' => $index === 6 ? 60 : 30,
                        'status' => $index === 0
